...
def parse_args(script):
    ...
    parser.add_argument('--dgr', default='', help='rotation degree')
    parser.add_argument('--fetch_epoch' , default=0, type=int,  help='specify the trained model parameter')
    parser.add_argument('--bvn'      , default='n',   help='b: base, v: val, n: novel')
    parser.add_argument('--re_size' , default=84, type=int, help='img size ')
    parser.add_argument('--flip', default='False', help="flipping")   
...
def get_resume_file(checkpoint_dir, fetch_epoch = 0):
    if fetch_epoch == 0:
